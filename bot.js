...
client.on("guildMemberAdd", async member => {
    ...
    const channel = member.guild.channels.cache.get(channelId)
      channel.send(message)
         member.send( "Decode this string : ```SSBhbSBub3QgYSBza2lkIGFuZCBJIHdpbGwgbm90IGFzayBxdWVzdGlvbnMgYWJvdXQgZGRvcyBhbmQgc2hpdA==``` ")
         .then((newmsg) => { //Now newmsg is the message you sent
            newmsg.channel.awaitMessages(response => response.content, {
              ...
              errors: ['time'],
                ...
                if (collected.first().content == "I am not a skid and I will not ask questions about ddos and shit") {
                    ...
                    newmsg1.awaitReactions(filter, { max: 1, time: 60000, errors: ['time'] })
                        .then(collected => {
                            ...
                            if (reaction.emoji.name === '1⃣') {
                                ...
                                const testFinal = new Discord.MessageEmbed()
                                    ...
                                    .then(collected => {
                                        ...
                                        if (reaction.emoji.name === '1⃣') {
                                            ...
                                            newmsg2.channel.send('Damn you a skid');
                                        }
                                    });
                                ...
                                newmsg1.channel.send('Damn you a skid');
                            }
                        })
                        .catch(collected => {
